...
$(document).ready(function() {
    ...
    createTable($("#statisticsTable"), {"supportsControllersDiscrimination": true, "overall": {"data": ["Total", 100, 0, 0.0, 110.19, 38, 239, 102.5, 171.9, 177.95, 238.8499999999999, 99.50248756218906, 19.531250000000004, 25.069962686567166], "isController": false}, "titles": ["Label", "#Samples", "KO", "Error %", "Average", "Min", "Max", "Median", "90th pct", "95th pct", "99th pct", "Transactions\/s", "Received", "Sent"], "items": [{"data": ["HTTP Request", 100, 0, 0.0, 110.19, 38, 239, 102.5, 171.9, 177.95, 238.8499999999999, 99.50248756218906, 19.531250000000004, 25.069962686567166], "isController": false}]}, function(index, item){
        switch(index){
            // Errors pct
            case 3:
                item = item.toFixed(2) + '%';
